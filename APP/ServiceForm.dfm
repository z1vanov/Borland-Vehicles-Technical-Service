object ServiceFormUnit: TServiceFormUnit
  Left = -8
  Top = -8
  Width = 1552
  Height = 840
  ...
  object ServicePanel: TPanel
    ...
    object ServiceLabelSearch: TLabel
      Left = 360
      Top = 18
      Width = 139
      Height = 20
    ...
    object ServiceEdit: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = ServiceEditChange
    end
    object ServiceSortCB: TComboBox
      Left = 136
      Top = 16
      Width = 200
      Height = 28
    ...
    object ServiceButtonSelect: TButton
      ...
      TabOrder = 2
      Visible = False
      OnClick = ServiceButtonSelectClick
    end
  end
  object ServiceDBNavigator: TDBNavigator
    Left = 0
    Top = 60
    Width = 1536
    Height = 28
    DataSource = DM.ServiceDS
    Align = alTop
    TabOrder = 1
  end
  object ServiceGrid: TDBGrid
    Left = 0
    Top = 88
    Width = 1536
    Height = 713
    Align = alClient
    DataSource = DM.AllServicesDS
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
